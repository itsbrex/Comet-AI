export const shortcutDefinitions = [
    ...
    { action: 'apple-intel-panel', label: 'Apple Intelligence Hub', category: 'AI', accelerator: 'CommandOrControl+Option+A' },
    { action: 'apple-intel-summary', label: 'Apple Smart Summary', category: 'AI', accelerator: 'CommandOrControl+Option+S' },
    { action: 'apple-intel-image', label: 'Apple Image Playground', category: 'AI', accelerator: 'CommandOrControl+Option+I' },
